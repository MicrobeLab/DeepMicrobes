...
This script makes predictions using the model of Embed + LSTM. 
...
EXAMPLE:
./predict_embed_lstm.sh -i sample.tfrec -b 8192 -p 8 -m model_dir -o prefix -d /path/to/DeepMicrobes
EOF
}
...
python ${main_dir}/DeepMicrobes.py \
	...
	--model_name=embed_lstm --encode_method=kmer \
	--model_dir=${model_dir} \
	--input_tfrec=${input} \
