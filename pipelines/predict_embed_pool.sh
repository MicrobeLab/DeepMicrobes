...
This script makes predictions using the model of Embed + Pool. 
...
EXAMPLE:
./predict_embed_pool.sh -i sample.tfrec -b 8192 -p 8 -m model_dir -o prefix -d /path/to/DeepMicrobes
EOF
}
...
python ${main_dir}/DeepMicrobes.py \
	...
	--model_name=embed_pool --encode_method=kmer \
	--model_dir=${model_dir} \
	--input_tfrec=${input} \
