...
This script makes predictions using the model of ResNet-like CNN. 
...
EXAMPLE:
./predict_deep_cnn.sh -i sample.tfrec -b 8192 -p 8 -m model_dir -o prefix -d /path/to/DeepMicrobes
EOF
}
...
python ${main_dir}/DeepMicrobes.py \
	...
	--model_name=deep_cnn --encode_method=one_hot \
	--model_dir=${model_dir} \
	--input_tfrec=${input} \
	--cpus=${cpu} \
	--translate=False \
